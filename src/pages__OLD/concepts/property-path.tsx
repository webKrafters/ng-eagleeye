    ...
    <article className={ `concept-property-path-page ${ className }` }>
        ...
        <div>
            ...
            <div>
                ...
                <Paragraph>
                    The <Name /> recognizes any property path abiding by the <Anchor
                        style={{
                            fontStyle: 'italic',
                            fontWeight: 500,
                            textDecoration: 'underline'
                        }}
                        to="https://lodash.com/docs#propertyOf"
                    >Lodash</Anchor> property path specifications. Such property paths may also contain negative integers.
                </Paragraph>
                ...
                <Paragraph>Either of the property paths <code>a.c.f.1</code>, <code>a.c.f.-2</code>, <code>a.c.f[1]</code> and <code>a.c.f[-2]</code> are all valid property paths to access the <code>a.c.f[1]=2</code> property.</Paragraph>
            ...
            <div>
                ...
                <Alert title={ <i><strong>Caution:</strong></i> }>
                    When this property path exists in a <Anchor to="/concepts/selector-map">selector map</Anchor>, any change in the state object results in an update of its <Anchor to="/concepts/channel"><code>channel.data</code></Anchor> and a subsequent notification of its client{ '(' }s{ ')' }.
                </Alert>
            </div>
        </div>
    </article>
